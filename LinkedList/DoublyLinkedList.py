...
doubly_linked_list_bp = Blueprint('doublyLinkedList', __name__, url_prefix='/doubly_linkedlist')
    ...
    <body>
        ...
        <script>
            async function insertNode() {
                ...
                let res = await fetch('/doubly_linkedlist/insert?value=' + val);
            ...
            async function deleteNode() {
                ...
                let res = await fetch('/doubly_linkedlist/delete?value=' + val);
                let data = await res.json();
                document.getElementById("status").innerText = data.message;
                drawList(data.list);
            }
...
@doubly_linked_list_bp.route('/insert')
def insert_node():
...
@doubly_linked_list_bp.route('/delete')
def delete_node():
    value = request.args.get('value')
    if value:
